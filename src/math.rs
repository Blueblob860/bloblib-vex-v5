...
pub fn sanitize_angle(angle: f64, radians: bool) -> f64 {
    if radians {
...
pub fn angle_error(target: f64, position: f64, radians: bool, direction: AngularDirection) -> f64 {
...
pub fn average(vals: Vec<f64>) -> f64 {
    vals.iter().fold(0.0, |a, v| a + v) / vals.len() as f64
}

pub fn ema(current: f64, previous: f64, smooth: f64) -> f64 {
